...
export class BalanceApi extends runtime.BaseAPI {
     ...
     * List Merchant Balance History
     */
    async getBalanceHistory(limit?: number, offset?: number, filter?: string, sort?: string, order?: string, merchantId?: string, startDate?: string, endDate?: string, transactionType?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BalanceHistoryResponseDto> {
        const response = await this.getBalanceHistoryRaw({ limit: limit, offset: offset, filter: filter, sort: sort, order: order, merchantId: merchantId, startDate: startDate, endDate: endDate, transactionType: transactionType }, initOverrides);
