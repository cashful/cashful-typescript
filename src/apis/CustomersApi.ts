...
import {
    ...
    BulkIdsDtoFromJSON,
    BulkIdsDtoToJSON,
    BulkUpdateCustomersInputDtoFromJSON,
    BulkUpdateCustomersInputDtoToJSON,
...
export interface UpdateCustomersBulkRequest {
    bulkUpdateCustomersInputDto: BulkUpdateCustomersInputDto;
}
...
export class CustomersApi extends runtime.BaseAPI {
     ...
     */
    async deleteCustomersBulkRaw(requestParameters: DeleteCustomersBulkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['bulkIdsDto'] == null) {
            throw new runtime.RequiredError(
                'bulkIdsDto',
                'Required parameter "bulkIdsDto" was null or undefined when calling deleteCustomersBulk().'
            );
        }
        ...
        let urlPath = `/api/canary/customers/bulk`;
     ...
     * Bulk Delete Customers
     */
    async deleteCustomersBulk(bulkIdsDto: BulkIdsDto, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.deleteCustomersBulkRaw({ bulkIdsDto: bulkIdsDto }, initOverrides);
        return await response.value();
    }
     ...
     * List Customers
     */
    async listCustomers(merchantId?: string, limit?: number, offset?: number, filter?: string, sort?: ListCustomersSortEnum, order?: string, email?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListCustomersResponseDto> {
        const response = await this.listCustomersRaw({ merchantId: merchantId, limit: limit, offset: offset, filter: filter, sort: sort, order: order, email: email }, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateCustomersBulkRaw(requestParameters: UpdateCustomersBulkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['bulkUpdateCustomersInputDto'] == null) {
            throw new runtime.RequiredError(
                'bulkUpdateCustomersInputDto',
                'Required parameter "bulkUpdateCustomersInputDto" was null or undefined when calling updateCustomersBulk().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: BulkUpdateCustomersInputDtoToJSON(requestParameters['bulkUpdateCustomersInputDto']),
        }, initOverrides);
     ...
     * Bulk Update Customers
     */
    async updateCustomersBulk(bulkUpdateCustomersInputDto: BulkUpdateCustomersInputDto, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.updateCustomersBulkRaw({ bulkUpdateCustomersInputDto: bulkUpdateCustomersInputDto }, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const ListCustomersSortEnum = {
    Id: 'id',
    Name: 'name',
    Email: 'email',
...
export type ListCustomersSortEnum = typeof ListCustomersSortEnum[keyof typeof ListCustomersSortEnum];
