...
export class CheckoutsApi extends runtime.BaseAPI {
     ...
     * List Checkout Sessions
     */
    async listCheckoutSessions(limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListCheckoutSessionsResponseDto> {
        const response = await this.listCheckoutSessionsRaw({ limit: limit, offset: offset }, initOverrides);
        return await response.value();
    }
