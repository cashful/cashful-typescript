...
*PaymentLinksApi* | [**deletePaymentLink**](docs/PaymentLinksApi.md#deletepaymentlink) | **DELETE** /api/canary/payment-links/{id} | Delete Payment Link
